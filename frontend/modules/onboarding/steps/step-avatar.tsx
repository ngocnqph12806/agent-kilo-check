  ...
  return (
    <div className="space-y-6">
      <header className="text-center">
        <h2 className="text-3xl font-extrabold tracking-tight text-[var(--brand-text-strong)]">
          Add a profile photo
        </h2>
      ...
      <div className="flex flex-col items-center gap-4 py-4">
        <div
          className="relative flex h-32 w-32 items-center justify-center overflow-hidden rounded-full bg-[var(--brand-hero-soft)] text-3xl font-bold text-primary shadow-brand-card ring-4 ring-white"
          aria-hidden
        >
          {preview ? (
      ...
      <p className="flex items-center justify-center gap-2 text-xs text-[var(--brand-text-subtle)]">
