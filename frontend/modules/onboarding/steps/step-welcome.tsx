  ...
  return (
    <div className="flex flex-col items-center px-4 py-12 text-center">
      ...
      <ul className="mt-10 grid w-full max-w-2xl gap-4 text-left sm:grid-cols-3">
        <li className="rounded-2xl border border-brand-default bg-card p-5 shadow-brand-card">
          <Users className="mb-3 h-6 w-6 text-primary" aria-hidden />
          <p className="font-semibold text-brand-strong">Match with 12+ partners</p>
        ...
        <li className="rounded-2xl border border-brand-default bg-card p-5 shadow-brand-card">
          ...
          <p className="font-semibold text-brand-strong">Claim 50 starter seeds</p>
          <p className="mt-1 text-sm text-brand-muted">
        ...
        <li className="rounded-2xl border border-brand-default bg-card p-5 shadow-brand-card">
          ...
          <p className="font-semibold text-brand-strong">No money changes hands</p>
          <p className="mt-1 text-sm text-brand-muted">
